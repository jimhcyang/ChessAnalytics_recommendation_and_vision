...
if __name__ == "__main__":
    ...
    num_correct_boards_allowing_one_mistake = (df["num_incorrect_squares"] <= 1).sum()
    print(
        "End-to-end accuracy, allowing one mistake:",
    ...
    print(
        "Per-square occupancy classification accuracy:",
    ...
    print(
        "Per-square piece classification accuracy:",
