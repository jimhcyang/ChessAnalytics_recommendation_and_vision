...
_DATA_DIR = Path(os.getenv("DATA_DIR", Path.home() / "chess_data"))
_CONFIG_DIR = Path(
    os.getenv("CONFIG_DIR", Path(__file__).parent.parent.parent.parent / "config")
)
_RUNS_DIR = Path(
    os.getenv("RUNS_DIR", Path(__file__).parent.parent.parent.parent / "runs")
)
_RESULTS_DIR = Path(
    os.getenv("RESULTS_DIR", Path(__file__).parent.parent.parent.parent / "results")
)
_MODELS_DIR = Path(
